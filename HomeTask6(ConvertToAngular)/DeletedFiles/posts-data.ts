...
export const POSTSDATA: Posts[] = [
    {
        ...
        postDesc: 'Delhi Chief Electoral Officer Ranbir Singh has written to the poll panel saying that a web series on Modi available on the Eros Now website was streaming without certification from the Media Certification and Monitoring Committee (MCMC).A senior official at the Delhi CEOs office reportedly said that they have brought to the notice of the ECI that a series on PM Narendra Modi is being screened on the Eros Now platform without MCMC certification. Since it not a Delhi specific matter, the CEO office has asked the ECI to take cognizance of the matter.'
    },
    {
        id: '2',
        imageSrc: 'https://dbjk47w5ep2rm.cloudfront.net/blog/wp-content/uploads/2015/03/Screen-Shot-2015-03-19-at-12.16.37-PM.png',
    ...
    },
    {
        ...
        postDate: '20th June , 2019',
        postCategory: 'THE-HINDU',
        // tslint:disable-next-line: max-line-length
        postDesc: 'Sundays shooting took place around 3.20 a.m. in the lively entertainment district of Melbournes southeastern suburb of Prahran, police said.Three security guards and a man queuing to enter were taken to hospital with gunshot injuries, police said in a televised news conference in Melbourne.'
    },
];
